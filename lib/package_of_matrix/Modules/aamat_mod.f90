MODULE MyMats
    ...
    END INTERFACE
    INTERFACE DIAG
    MODULE PROCEDURE DIAG_R, DIAG_I, DIAG_G
    END INTERFACE
    INTERFACE SECONDS
...
CONTAINS
    ...
    END SUBROUTINE DIAG_I
      ...
      SUBROUTINE DIAG_G(A,U,W)
        ...
        INTEGER ND1,ND2, MATZ,IERR, I,J
        REAL (KIND=8), DIMENSION( :), ALLOCATABLE :: FV1,FV2,WR,WI
        REAL (KIND=8), DIMENSION(:,:), ALLOCATABLE :: AR,AI, ER, EI, FM1
         ...
         DO J = 1,ND1
            ...
            ENDDO
         ENDDO
         CALL CG(ND1,ND1,AR,AI, WR,WI, MATZ,ER,EI, FV1,FV2,FM1,IERR)
         DO J = 1,ND1
            DO I = 1,ND1
               U(I,J) = DCMPLX (ER(I,J), EI(I,J))
            ENDDO
